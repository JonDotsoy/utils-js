...
Build declarative and chainable queries over data structures, ideal for use with the `visit` function. Easily filter nodes by instance, properties, values, matches, or custom predicates in a fluent and expressive way.
...
**Advanced integration example with visit:**
